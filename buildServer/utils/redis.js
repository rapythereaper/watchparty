...
function redisCount(prefix) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const key = `${prefix}:${time_1.getStartOfHour()}`;
        yield redis.incr(key);
        yield redis.expireat(key, time_1.getStartOfHour() + 86400 * 1000);
    });
}
...
function getRedisCountHour(prefix) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const value = yield redis.get(`${prefix}:${time_1.getStartOfHour() - 3600 * 1000}`);
        return Number(value);
    });
}
...
function getRedisCountHourDistinct(prefix) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // Get counts for previous full hour
        return yield redis.pfcount(`${prefix}:${time_1.getStartOfHour() - 3600 * 1000}`);
    });
}
