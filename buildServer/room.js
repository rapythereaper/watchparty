...
class Room {
    constructor(io, roomId, roomData) {
        ...
        this.getRosterForStats = () => {
            return this.roster.map((p) => {
                ...
                return ({
                    ...
                    ts: this.tsMap[p.id],
                    ip: (_c = (_b = (_a = this.io.of(this.roomId).sockets[p.id]) === null || _a === void 0 ? void 0 : _a.request) === null || _b === void 0 ? void 0 : _b.connection) === null || _c === void 0 ? void 0 : _c.remoteAddress,
                });
            });
        };
        this.getHostState = () => {
        ...
        this.playlistAdd = (socket, data) => __awaiter(this, void 0, void 0, function* () {
            ...
            redis_1.redisCount('playlistAdds');
            const youtubeVideoId = youtube_1.getYoutubeVideoID(data);
            if (youtubeVideoId) {
                const video = yield youtube_1.fetchYoutubeVideo(youtubeVideoId);
        ...
        this.kickUser = (socket, data) => __awaiter(this, void 0, void 0, function* () {
            ...
            const userToBeKickedSocket = this.io.of(this.roomId).connected[data.userToBeKicked];
